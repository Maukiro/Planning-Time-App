...
class menu_principal2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val movetochatbot = findViewById<ImageButton>(R.id.imageButtonChatBot)
        movetochatbot.setOnClickListener {
            val intent = Intent(this@menu_principal2, Chatbot::class.java)
            startActivity(intent)
        }
    }
}