...
class SQLite(
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        db?.execSQL("CREATE TABLE IF NOT EXISTS usuarios (nombreUsuario TEXT,correo TEXT PRIMARY KEY, contraseña TEXT)")
        ...
        //
        db?.execSQL("CREATE TABLE IF NOT EXISTS bot (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, consejo TEXT, metodo Text)")
    }
